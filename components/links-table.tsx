                  ...
                  <TableRow key={link.id}>
                    <TableCell>
                      <div className="space-y-1">
                        <p className="font-medium text-sm">{truncateUrl(link.originalUrl)}</p>
                        <p className="text-xs text-muted-foreground font-mono">{link.shortUrl}</p>
                      </div>
                    </TableCell>
                    <TableCell>
                      <code className="text-sm font-mono bg-muted/50 px-2 py-1 rounded">{link.shortCode}</code>
                    </TableCell>
                    <TableCell>
                      <span className="font-medium">{link.clicks}</span>
                    </TableCell>
                    <TableCell>
                      <Badge variant={link.isActive !== false ? "default" : "secondary"}>
                    ...
                    <TableCell>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <DropdownMenuItem
                            onClick={() => onToggleStatus(link.id, link.isActive === false)}
                            className="cursor-pointer"
                          >
